...
public class KeyInput : MonoBehaviour
{
    ...
    //private OVRHand.HandFinger pinchedFinger;
    ...
    {
        pauseInput();
        //OVRHand ovrHand = other.GetComponentInParent<OVRHand>();

        //if (!ovrHand.GetFingerIsPinching(pinchedFinger))
        //{
        //    pauseInput();
        //    transform.Find("root 1").GetComponent<Renderer>().material.color = defColor;
        //    isPinching = false;
        //}
    }
    ...
    //    if (ovrHand != null)
    //    {
    //        if(other.gameObject.tag != "oya")
    //        {
    //            if (ovrHand.GetFingerIsPinching(OVRHand.HandFinger.Index))
    //            {
    //                pinchedFinger = OVRHand.HandFinger.Index;
    //                defColor = transform.Find("root 1").GetComponent<Renderer>().material.color;
    //                transform.Find("root 1").GetComponent<Renderer>().material.color = Color.yellow;
    //                if(!isPinching) putChar(other);
    //                isPinching = true;
    //            }
    //            else if (ovrHand.GetFingerIsPinching(OVRHand.HandFinger.Middle))
    //            {
    //                pinchedFinger = OVRHand.HandFinger.Middle;
    //                defColor = transform.Find("root 1").GetComponent<Renderer>().material.color;
    //                transform.Find("root 1").GetComponent<Renderer>().material.color = Color.yellow;
    //                putChar(other);
    //            }
    ...
    //            {
    //                pinchedFinger = OVRHand.HandFinger.Ring;
    //                defColor = transform.Find("root 1").GetComponent<Renderer>().material.color;
    //                transform.Find("root 1").GetComponent<Renderer>().material.color = Color.yellow;
    //                putChar(other);
    //            }
    //            else if (ovrHand.GetFingerIsPinching(OVRHand.HandFinger.Pinky))
    //            {
    //                pinchedFinger = OVRHand.HandFinger.Pinky;
    //                defColor = transform.Find("root 1").GetComponent<Renderer>().material.color;
    //                transform.Find("root 1").GetComponent<Renderer>().material.color = Color.yellow;
    //                putChar(other);
    //            }
